...
`:person_with_blond_hair:`|:person_with_blond_hair:|`:man_with_gua_pi_mao:`|:man_with_gua_pi_mao:
`:construction_worker:`|:construction_worker:|`:cop:`|:cop:
`:princess:`|:princess:|`:smiley_cat:`|:smiley_cat:
...
` :arrow_down:`| :arrow_down:|` :arrow_forward:`| :arrow_forward:
...
`:x:`|:x:|`:heavy_exclamation_mark:`|:heavy_exclamation_mark:
...
`:ballot_box_with_check:`|:ballot_box_with_check:|` :radio_button:`| :radio_button:
