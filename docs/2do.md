...
- [ ] :kissing_cat: :two: go through other review preparation materials
    ...
    - [ ] :arrow_right_hook: 有消息中间件开发经验，如activemq，rabbitmq或kafka等
    - [ ] :arrow_right_hook: :two: linux/unix server monitoring tools, such as iostat, vmstat, mpstat, top, sar, and etc
...
- [ ] :kissing_cat: :two: running github home page
    ...
    - [ ] :smiley_cat: :one: learn ecnomics
        ...
        - [ ] :cat: :one: Virtual box set up        
            ...
            - [ ] :pouting_cat: :two: 在以后闲的时候看看互联网的书, W.Richard Stevens著的《TCP/IP详解三卷》，《UNIX网络编程二卷》，《UNIX环境高级编程：第2版》
